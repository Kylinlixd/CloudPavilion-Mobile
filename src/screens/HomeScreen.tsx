...
import type { Dashboard, Loan, Recommendation, User } from '../lib/types'
...
export function HomeScreen() {
  ...
  useFocusEffect(useCallback(() => { let active = true; void apiClient.get<User>('/auth/me/').then((r) => { if (active) setUser(r) }).catch(() => undefined); return () => { active = false } }, []))
